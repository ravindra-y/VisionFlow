      ...
      <div className="locations-container">
          ...
          <div className="header-top">
            <div className="header-left">
              ...
              <p className="location-detail-coords">
                {currentLocation.lat}, {currentLocation.lng} • {currentLocation.distance}
              </p>
            </div>
            <div className="header-right">
              <span className={`quality-badge badge-${currentLocation.badge.toLowerCase().replace(' ', '-')}`}>
        ...
        <div className="metrics-grid">
          <div className="metric-card">
            ...
            <div className="metric-content">
              <div className="metric-icon-wrapper">
                <Eye className="metric-icon" size={32} />
              </div>
              <div className="metric-details">
                <span className="metric-value">{currentLocation.visibility}%</span>
                <span className="metric-change positive">{currentLocation.visibilityChange}</span>
              </div>
            </div>
          </div>
          ...
          <div className="metric-card">
            ...
            <div className="metric-content">
              <div className="metric-icon-wrapper cloud-icon">
                <Cloud className="metric-icon" size={32} />
              </div>
              <div className="metric-details">
                <span className="metric-value">{currentLocation.cloud}%</span>
                <span className="metric-change negative">↓ {currentLocation.cloudChange}</span>
              </div>
            </div>
          </div>
          ...
          <div className="metric-card">
            ...
            <div className="metric-content">
              <div className="metric-icon-wrapper pollution-icon">
                <Lightbulb className="metric-icon" size={32} />
              </div>
              <div className="metric-details">
                <span className="metric-value">{currentLocation.pollution}</span>
                <span className="metric-unit">{currentLocation.pollutionUnit}</span>
              </div>
            </div>
          </div>
          ...
          <div className="metric-card">
            ...
            <div className="metric-content">
              ...
              <div className="metric-details">
                <span className="metric-value">{currentLocation.elevation}</span>
                <span className="metric-unit">{currentLocation.elevationDetail}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="location-selector">
          ...
          <div className="location-chips">
            {locationsData.map((location, index) => (
              <button
                key={location.id}
                className={`location-chip ${selectedLocation === index ? 'active' : ''}`}
        ...
        <div className="charts-section">
          <div className="chart-card">
            <div className="chart-header">
              ...
              <p className="chart-subtitle">Monthly average star visibility score</p>
            </div>
        ...
        <div className="hourly-forecast-section">
          <div className="forecast-header">
            ...
            <p className="forecast-subtitle">Detailed hour-by-hour sky conditions</p>
          </div>
          ...
          <div className="forecast-table">
            ...
            <div className="forecast-table-body">
              <div className="forecast-row">
                ...
                <div className="forecast-cell">
                  <div className="visibility-cell">
                    <div className="visibility-bar" style={{ width: '85%' }}></div>
              ...
              <div className="forecast-row">
                ...
                <div className="forecast-cell">
                  <div className="visibility-cell">
                    <div className="visibility-bar" style={{ width: '88%' }}></div>
              ...
              <div className="forecast-row">
                ...
                <div className="forecast-cell">
                  <div className="visibility-cell">
                    <div className="visibility-bar" style={{ width: '92%' }}></div>
                    <span className="visibility-text">92%</span>
                  </div>
                  <div>10%</div>
                  <div>20°C</div>
                  <div>
                    <span className="condition-badge condition-very-good">Very Good</span>
                  </div>
                </div>
              </div>
              ...
              <div className="forecast-row">
                ...
                <div className="forecast-cell">
                  <div className="visibility-cell">
                    <div className="visibility-bar" style={{ width: '94%' }}></div>
              ...
              <div className="forecast-row">
                ...
                <div className="forecast-cell">
                  <div className="visibility-cell">
                    <div className="visibility-bar" style={{ width: '95%' }}></div>
                    <span className="visibility-text">95%</span>
                  </div>
                  <div>8%</div>
                  <div>18°C</div>
                  <div>
                    <span className="condition-badge condition-excellent">Excellent</span>
                  </div>
                </div>
              </div>
              ...
              <div className="forecast-row">
                ...
                <div className="forecast-cell">
                  <div className="visibility-cell">
                    <div className="visibility-bar" style={{ width: '96%' }}></div>
